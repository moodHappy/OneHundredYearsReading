...
<body>
    ...
    <div class="modal" id="modal">
        <div class="modal-content">
            ...
            <p style="font-size:0.8rem; color:#888; margin-top:-10px;">仓库已被钢筋水泥焊死，仅需 Token！</p>
    ...
    <script>
        ...
        async function pushToGitHub() {
            ...
            try {
                const base64Html = utf8ToBase64(targetHtml);
        ...
        // 终极独立页面模板，原生 textarea 数据容灾，无保存按钮无痕体验
...
<body>
    ...
    <script>
        ...
        // 失去焦点时：自动恢复视图，比对内容，静默推送到 GitHub！
        editBlock.addEventListener('blur', async () => {
        ...
        async function saveToGitHub() {
            const token = localStorage.getItem('GH_TOKEN');
            if(!token) {
                alert("编辑成功，但未检测到 Token，无法同步到云端！");
                return;
            }
